            ...
            <div class="row align-items-center">
              ...
              <div class="col-lg order-lg-first">
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo base_url('index.php/penjual')?>" class="nav-link <?php if($this->router->method == 'index'){echo 'active';}?>"><i class="fe fe-box"></i> Dashboard</a>
                  </li>
                  <li class="nav-item">
                    <a href="<?php echo base_url('index.php/penjual/usersetting')?>" class="nav-link <?php if($this->router->method == 'usersetting'){echo 'active';}?>"><i class="fe fe-box"></i> Settings</a>
                  </li>
                   <li class="nav-item">
                    <a href="<?php echo base_url('index.php/penjual/logout') ?>" class="nav-link"><i class="fe fe-box"></i> Logout</a>
                  </li>
                </ul>
              </div>
            </div>
